...
powershell -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/hoangduc981998/WindowsCleanupTool/main/CleanUpTool.ps1' -OutFile '%USERPROFILE%\CleanupTool\CleanUpTool.ps1'"
...
echo @echo off > "%USERPROFILE%\Desktop\ChayDonDep.bat"
echo powershell.exe -ExecutionPolicy Bypass -File "%%USERPROFILE%%\CleanupTool\CleanUpTool.ps1" >> "%USERPROFILE%\Desktop\ChayDonDep.bat"

echo.
echo Cai dat hoan tat!
echo Ban co the chay chuong trinh bang cach nhap doi vao shortcut "Don Dep He Thong" tren Desktop
echo hoac chay file "ChayDonDep.bat"
echo.
